...
The British Library 'Shakespeare' dataset is a set of .csv (comma separated value) files containing metadata for resources relating to William Shakespeare, from the British National Bibliography (BNB) and our British Library collections. It was initially released to accompany the British Library's exhibition 'Shakespeare in Ten Acts' in 2016, and has been updated annually thereafter. 
