...
|       To give you a face to the name, below are a few of Nature's Prophets spells he can cast in the game. Picture was clipped together from [Dota's official site](https://www.dota2.com/hero/nature'sprophet)
```{r, out.width="95%",fig.align="center", echo = FALSE}
knitr::include_graphics("https://github.com/d-ev-craig/DATA607/blob/main/Projects/Project4%20-%20'Document'%20Classification/NPFace.png?raw=true")
```
