...
knitr::include_graphics("C:\\repos\\DATA607\\Projects\\Project4 - 'Document' Classification\\Prize.png")
```
...
```{r}
npData<-read_csv("C:\\repos\\DATA607\\Projects\\Project4 - 'Document' Classification\\NPBase.csv")
