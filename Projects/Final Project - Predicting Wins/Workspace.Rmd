...
#Thresholding
Can adjust the threshold of log odds at which it would be predicted as a win as below. Recall that if the log odds are above .5, it will be predicted a win. Sometimes you may want to adjust this for accruacy.
```{r}
predsClass$set_threshold(0.7)
predsClass$confusion
```
